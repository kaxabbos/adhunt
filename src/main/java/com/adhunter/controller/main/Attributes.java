package com.adhunter.controller.main;

import com.adhunter.model.enums.*;
...
public class Attributes extends Main {
    ...
    protected void AddAttributesIndexSearch(Model model, String search, Category category, Type type, Region region) {
        ...
        model.addAttribute("ads", adsRepo.findAllByNameContainingAndStatusAndDescription_CategoryAndDescription_RegionAndDescription_Type(search, adStatus.ACTIVE, category, region, type));
    }
    ...
    protected void AddAttributesIndexSearchRegion(Model model, Region region) {
        ...
        AddAttributesEnums(model);
        model.addAttribute("tSelect", region);
        model.addAttribute("ads", adsRepo.findAllByStatusAndDescription_Region(adStatus.ACTIVE, region));
    }
